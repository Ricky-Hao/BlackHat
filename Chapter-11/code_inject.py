...
sys.path.append("/home/ricky/Git/volatility")
        ...
        if physical is not None:
            if slack_space is None:
                ...
                try:
                    ...
                    #创建我们的跳转代码
                    tramp = "\xbb%s" % struct.ack(",L", page[0] + offset)
                    tramp += "\xff\xe3"
            ...
            if page[0] <= equals_button and equals_button < ((page[0] + page[1])-7):
                print("[*] Found out trampoline target at: 0x%08x" % physical)
